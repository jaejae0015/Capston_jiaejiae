...
public class MainAcivity_cal_aditm extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent_btn_calsearch_home3=new Intent(MainAcivity_cal_aditm.this, MainActivity_cal_day_morning.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        piechart_searchplusm = (PieChart)findViewById(R.id.piechart_editm);//객체를 생성해주고



        sp = (Spinner)findViewById(R.id.spinner_calsearchplus);
        ...
        try {
            String result = new CustomTask().execute("0", foodname_m_edit,"0","0","morning_edit_kcal","0").get();
            ...
            if (result.equals("ok")) {
                ...
                txt_calsearchplus_kcal2.setText(kcal_morning);
    ...
    class CustomTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                String str;
                URL url = new URL("http://192.168.56.1:8080/Cap_Connection_2/EditFoodM.jsp");//바꿔주세요
        ...
        public void onClick(View view1) {
            ...
            switch (view1.getId()) {
                ...
                case R.id.btn_calsearchplus_save2:
                    ...
                    try {
                        String result = new CustomTask().execute(nickdata,foodname_m_edit,day,search_m_g,"search_edit",text).get();
