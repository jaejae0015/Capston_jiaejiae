                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                try {
                                    ...
                                    if (result.equals("ok")) {
                                        Toast.makeText(MainActivity_culture_categorymain3.this, "삭제완료", Toast.LENGTH_SHORT).show();
                                        ...
                                        try {
                                            ...
                                            adapter.clear();
                                            if (result.equals("ok")) {
                                                Toast.makeText(MainActivity_culture_categorymain3.this, result2 + "연결ok", Toast.LENGTH_SHORT).show();
                                               // list_calday_listView_categorymain3_1.add(0, "데이터가 없습니다");
                                                adapter.notifyDataSetChanged();
                                            } else {
                                                adapter.clear();
                                                Toast.makeText(MainActivity_culture_categorymain3.this, result2 + "연결ok", Toast.LENGTH_SHORT).show();
                                                //title+content분리하는 작업 해주고
 ...
 */
        ...
        try {
            ...
            if (result.equals("ok")) {
                Toast.makeText(MainActivity_culture_categorymain3.this, result + "연결ok", Toast.LENGTH_SHORT).show();
                //list_calday_listView_categorymain3_1.add(0, "데이터가 없습니다");
                adapter.notifyDataSetChanged();
            } else {
                adapter.clear();
            ...
            switch (view1.getId()) {
                ...
                case R.id.btn_culture_categorymain3_search:
                    ...
                    try {
                        ...
                        if (result.equals("ok")) {
                            Toast.makeText(MainActivity_culture_categorymain3.this, "연결ok", Toast.LENGTH_SHORT).show();
