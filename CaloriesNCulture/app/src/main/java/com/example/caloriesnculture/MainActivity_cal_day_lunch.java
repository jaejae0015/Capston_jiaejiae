...
public class MainActivity_cal_day_lunch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                try {
                                    ...
                                    if (result.equals("ok")) {
                                        Toast.makeText(MainActivity_cal_day_lunch.this, "삭제완료", Toast.LENGTH_SHORT).show();
                                        ...
                                        try {
                                            ...
                                            adapter.clear();
                                            if (result.equals("ok")) {
                                                Toast.makeText(MainActivity_cal_day_lunch.this, result2 + "연결ok", Toast.LENGTH_SHORT).show();
        ...
        try {
            ...
            if (result.equals("ok")) {
                Toast.makeText(MainActivity_cal_day_lunch.this, result + "연결ok", Toast.LENGTH_SHORT).show();
                adapter.notifyDataSetChanged();
            } else {
                Toast.makeText(MainActivity_cal_day_lunch.this, result + "연결ok", Toast.LENGTH_SHORT).show();
                StringTokenizer st = new StringTokenizer(result, "&");
    ...
    class CustomTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                String str;
                URL url = new URL("http://106.241.33.158:1080/SelectLunch.jsp");//바꿔주세요
