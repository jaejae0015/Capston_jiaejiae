...
public class MainAcivity_cal_aditl extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent_btn_calsearch_home3=new Intent(MainAcivity_cal_aditl.this, MainActivity_cal_day_lunch.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        piechart_searchplusm = (PieChart)findViewById(R.id.piechart_editl);//객체를 생성해주고

        sp = (Spinner)findViewById(R.id.spinner_calsearchplus2);
        ...
        try {
            String result = new CustomTask().execute("0", foodname_l_edit,"0","0","lunch_edit_kcal","0").get();
            ...
            if (result.equals("ok")) {
                ...
                protein=array[2];
                fat=array[3];
                txt_calsearchplus_kcal3.setText(kcal_morning);
    ...
    class CustomTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                String str;
                URL url = new URL("http://106.241.33.158:1080/EditFoodL.jsp");//바꿔주세요
        ...
        public void onClick(View view1) {
            ...
            switch (view1.getId()) {
                ...
                case R.id.btn_calsearchplus_save3:
                    ...
                    try {
                        String result = new CustomTask().execute(nickdata,foodname_l_edit,day,search_m_g,"search_editl",text).get();
